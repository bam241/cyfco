...
#pragma cyclus def clone cyfco::Reactor

#pragma cyclus def schema cyfco::Reactor

#pragma cyclus def annotations cyfco::Reactor

#pragma cyclus def infiletodb cyfco::Reactor

#pragma cyclus def snapshot cyfco::Reactor

#pragma cyclus def snapshotinv cyfco::Reactor

#pragma cyclus def initinv cyfco::Reactor

void Reactor::InitFrom(Reactor* m) {
  #pragma cyclus impl initfromcopy cyfco::Reactor
  cyclus::toolkit::CommodityProducer::Copy(m);
}

void Reactor::InitFrom(cyclus::QueryableBackend* b) {
  #pragma cyclus impl initfromdb cyfco::Reactor
...
std::string Reactor::fuel_incommod(Material::Ptr m) {
  ...
  if (i >= fuel_incommods.size()) {
    throw KeyError("cyfco::Reactor - no incommod for material object");
  }
...
std::string Reactor::fuel_outcommod(Material::Ptr m) {
  ...
  if (i >= fuel_outcommods.size()) {
    throw KeyError("cyfco::Reactor - no outcommod for material object");
  }
...
std::string Reactor::fuel_inrecipe(Material::Ptr m) {
  ...
  if (i >= fuel_inrecipes.size()) {
    throw KeyError("cyfco::Reactor - no inrecipe for material object");
  }
...
std::string Reactor::fuel_outrecipe(Material::Ptr m) {
  ...
  if (i >= fuel_outrecipes.size()) {
    throw KeyError("cyfco::Reactor - no outrecipe for material object");
  }
...
void Reactor::index_res(cyclus::Resource::Ptr m, std::string incommod) {
  ...
  throw ValueError(
      "cyfco::Reactor - received unsupported incommod material");
}
